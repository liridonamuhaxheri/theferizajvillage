                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ename" class="form-control" placeholder="First Name *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="esurname"class="form-control" placeholder="Last Name *" value="" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" minlength="10" maxlength="10" name="ephone" class="form-control" placeholder="Phone *" value="" />
                                        </div>
