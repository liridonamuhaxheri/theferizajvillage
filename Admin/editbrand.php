...
if (isset($_SESSION['admin'])){
  $id=$_GET['bid'];
  $query="select * from brands where bid=$id";
                    ...
                    <div class="col-md-9 register-right">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Edit Brand</h3>
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <form action="editbrn.php" method="post">
                                                <input type="hidden" name="bid" value=<?php echo $row->bid?>>
                                            <input type="text" name="name" class="form-control" placeholder="Brand Name *" value="<?php echo $row->name?> " />
                                        </div>
                                        <div class="form-group">
